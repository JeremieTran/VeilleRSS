...
function preparePrivateOptions(...arguments_) {
    ...
    // ** use it to oweverwrite the default options
        ...
        result.targetDirectoryPath = node_path_1.default.resolve(result.callerDirectoryPath, result.targetDirectoryPath);
    ...
    // ** use it to oweverwrite the default options
        ...
        options.targetDirectoryPath = node_path_1.default.resolve(options.callerDirectoryPath, arguments_[0]);
    }
    ...
    // ** throw an error
        ...
        throw new TypeError(`Expected undefined, object, string or function as first argument, but got: ${typeof arguments_[0]}`);
    }
...
exports.default = preparePrivateOptions;
